...
export const data_S = {
    'sixDataSum': [58, 53, 50, 50, 64], 'WP': {
        ...
        'person': '5万',
        'star': ['防反　★', '内伤　★★★'],
        'inf': '　　武当派武功博大精深，最重内功修养，创派祖师真君道法高深，太极神功名满天下，堪称天下内家功法第一。',
        ...
        'person': '5万',
        'star': ['防御　★', '外伤　★★★'],
        'inf': '　　少林寺乃武林中的泰山北斗。菩提达摩祖师以禅入武，在少林寺创出“七十二绝技”，无不冠绝天下。',
        ...
        'zAtt': {
            ...
            '啄目争珠': {
                ...
                'hurt_b': 0,
                'hurt_p': 0,
                'TX_inf': '对方-40%闪避，-50%命中，2s',
                'LZ_inf': '命中+5%，5s',
                'remark': '以双眼为目标，中招者绝无还手之力',
                'LZ_Data': {'hit': [0.05, 5]},
                'TX_Data': {'dod_to': [-0.4, 2], 'hit_to': [-0.5, 2]},
                'count_tt': 0,
                'count_all': 0
            },
            '怒鹰锁喉': {
        ...
        'person': '3万',
        'star': ['毒伤　★★★', '内伤　★'],
        'inf': '　　苗疆五毒教，自称五仙教，教义甚是极端，恩仇必报。教中炼毒、养蛊诸多奇诡之术，无不骇人听闻。',
        ...
        'zAtt': {
            '蛛网缠': {
                ...
                'LZ_inf': '本招毒伤害+5',
                'remark': '五毒教两大牵制神技之一',
                'LZ_Data': {'hurt_p': [5, 0.1]},
                'TX_Data': {'poison': 'WJ_MJ', 'special': 1},
                'count_tt': 0,
                'count_all': 0
            },
            '五毒神掌': {
            ...
            '青蛇刁手': {
                ...
                'TX_inf': '【青蛇毒】',
                'LZ_inf': '命中率+5%，5s',
                'remark': '毒发各部位-33%当前hp，【青蛇毒】积累>30，智力-1',
                'LZ_Data': {'hit': [0.05, 5]},
                'TX_Data': {'poison': 'WJ_ZL'},
                'count_tt': 0,
                'count_all': 0
            },
            '三阴蜈蚣爪': {
                ...
                'TX_inf': '【蜈蚣毒】',
                'LZ_inf': '毒伤害+5，5s',
                'remark': '毒发各部位-33%当前hp，【蜈蚣毒】积累>30，体魄-1',
                'LZ_Data': {'hurt_p': [5, 5]},
                'TX_Data': {'poison': 'WJ_TP'},
                'count_tt': 0,
                'count_all': 0
            },
            '蝎子摆尾': {
                ...
                'TX_inf': '【蝎子毒】',
                'LZ_inf': '内伤伤害+5%，5s',
                'remark': '毒发各部位-33%当前hp，【蝎子毒】积累>30，力量-1',
                'LZ_Data': {'hurt_i': [0.05, 5]},
                'TX_Data': {'poison': 'WJ_LL'},
                'count_tt': 0,
                'count_all': 0
            },
            '千蛛万毒手': {
                ...
                'TX_inf': '【蜘蛛毒】',
                'LZ_inf': '毒伤害+5，5s',
                'remark': '毒发各部位-33%当前hp，【蜘蛛毒】积累>30，敏捷-1',
                'LZ_Data': {'hurt_p': [5, 5]},
                'TX_Data': {'poison': 'WJ_MJ'},
                'count_tt': 0,
                'count_all': 0
            },
            '毒蟾砂': {
                ...
                'hurt_b': 0,
                'hurt_p': 25,
                'TX_inf': '不能格挡，封锁对方真气回复3s。【蟾蜍毒】内功-1',
                'LZ_inf': '毒伤害+5，5s',
                'remark': '毒发各部位-33%当前hp，【蟾蜍毒】积累>30，内力-1',
                'LZ_Data': {'hurt_p': [5, 5]},
                'TX_Data': {'poison': 'WJ_NL'},
                'count_tt': 0,
                'count_all': 0
            },
        },
        ...
        'person': '4万',
        'star': ['破绽　★★★', '削耐　★'],
        'inf': '　　段氏一派出身中原武林世家，虽贵为皇族，家传武功却从来不曾荒废，反而愈加勤奋，皇室成员多为高手。',
        ...
        'zAtt': {
            ...
            '少商剑': {
                ...
                'LZ_Data': {'hurt_o': [0.05, 5], 'hurt_i': [0.05, 5]},
                'TX_Data': {'flaw_to': [0.1, 10]},
                'count_tt': 0,
                'count_all': 0
            },
            '商阳剑': {
            ...
            '中冲剑': {
                ...
                'hurt_p': 0,
                'TX_inf': '对方所有破绽率+10%，10s',
                'LZ_inf': '直接命中时，本次真气伤害+100%',
                'remark': '大开大阖，气势雄迈',
                'LZ_Data': {'hurt_q': [1, 0.1]},
                'TX_Data': {'flaw_to': [0.1, 10]},
                'count_tt': 0,
                'count_all': 0
            },
            ...
            '五罗轻烟掌': {
                ...
                'hurt_p': 0,
                'TX_inf': '内外伤伤害+10%，5s',
                'LZ_inf': '五罗轻烟掌特效加倍，时间不变',
                'remark': '飘渺轻盈，招数精奇，拥有多重变势。',
                'LZ_Data': {'changeTX': {'hurt_o': [0.2, 5], 'hurt_i': [0.2, 5]}},
                'TX_Data': {'hurt_o': [0.1, 5], 'hurt_i': [0.1, 5]},
                'count_tt': 0,
                'count_all': 0
            },
        },
        ...
        'person': '4万',
        'star': ['闪反　★', '内伤　★★', '外伤　★★'],
        'inf': '　　峨眉派派如其名——“天下秀”。峨眉武学刚柔并济，道释相融，定慧双修。',
        ...
        'zAtt': {
            ...
            '金刚诛灭手': {
                ...
                'hurt_b': 0,
                'hurt_p': 0,
                'TX_inf': '若命中，防御-20%，5s；若格挡，格挡率-20%，5s',
                'LZ_inf': '诛灭手特效加倍，时间不变',
                'remark': '[暂无数据] - 006',
                'LZ_Data': {'changeTX': {'def_o': [-0.4, 5], 'def_i': [-0.4, 5], 'block': [-0.4, 5]}},
                'TX_Data': {'def_o': [-0.2, 5], 'def_i': [-0.2, 5], 'block': [-0.2, 5]},
                'count_tt': 0,
                'count_all': 0
            },
            '金刚黑砂掌': {
            ...
            '大日如来掌': {
                ...
                'TX_inf': '封锁对方真气回复3s',
                'LZ_inf': '真气伤害 +5%，5s',
                'remark': '相传是如来为了普度众生，解劫除厄，传与凡人的一套绝世武学，神掌威力可敌天灾地祸，降妖除魔',
                'LZ_Data': {'hurt_q': [0.05, 5]},
                'TX_Data': {'lock_zq': 3},
                'count_tt': 0,
                'count_all': 0
        ...
        'person': '2万',
        'star': ['闪避　★★', '毒伤　★', '流血　★', '破绽　★'],
        'inf': '　　唐门，以「机关」，「毒药」和「暗器」雄踞蜀中的武林世家。门内弟子行事诡秘，行为飘忽。',
        ...
        'zAtt': {
            '子午毒砂': {
                ...
                'hurt_b': 0,
                'hurt_p': 25,
                'TX_inf': '不能格挡，敌方命中-20%，破绽+10%，5s',
                'LZ_inf': '毒伤害+5，5s',
                'remark': '以毒砂射向对方眼睛，阴险至极',
                'LZ_Data': {'hurt_p': [5, 5]},
                'TX_Data': {'hit_to': [-0.2, 5], 'flaw_to': [0.1, 5]},
                'count_tt': 0,
                'count_all': 0
            },
            '毒蒺藜': {
                ...
                'hurt_b': 5,
                'hurt_p': 0,
                'TX_inf': '流血持续 5s，破绽+10%，3s',
                'LZ_inf': '流血伤害+5/s，5s',
                'remark': '【秘毒】毒发时，触发部位hp-最大值的50%，破绽+20%',
                'LZ_Data': {'hurt_b': [5, 5]},
                'TX_Data': {'blood_last': 5, 'flaw_to': [0.1, 3]},
                'count_tt': 0,
                'count_all': 0
            },
            '暴雨梨花针': {
            ...
            '血天腐地炮': {
                ...
                'hurt_b': 10,
                'hurt_p': 30,
                'TX_inf': '流血持续 5s，敌方命中-5%，破绽+10%，5s',
                'LZ_inf': '闪避+5%，5s',
                'remark': '[暂无数据] - 016',
                'LZ_Data': {'dod': [0.05, 5]},
                'TX_Data': {'blood_last': 5, 'flaw_to': [0.1, 5], 'hit_to': [-0.05, 5]},
                'count_tt': 0,
                'count_all': 0
            },
        },
        ...
        'person': '2万',
        'star': ['毒伤　★★', '流血　★★★'],
        'inf': '　　相传万恶之徒聚首创立了血犼教。教中魔功乱人本性，教众嗜血好杀，菩萨亦难救。',
        ...
        'zAtt': {
            ...
            '血煞掌': {
                ...
                'hurt_b': 15,
                'hurt_p': 0,
                'TX_inf': '结算当前部位流血伤害，再新增流血，流血持续 5s，',
                'LZ_inf': '流血伤害+5/s，5s',
                'remark': '[暂无数据] - 022',
                'LZ_Data': {'hurt_b': [5, 5]},
                'TX_Data': {'blood_last': 5, 'special': 1},
                'count_tt': 0,
                'count_all': 0
            },
            '大阴风腿': {
        ...
        'person': '1万',
        'star': ['防反　★★', '防御　★★★', '外伤　★'],
        'inf': '　　狮相门武学横行霸道，虽不重视内功修为，但横练硬气功独步天下，可开金断石、刀枪不入，堪称外家功法极致。',
        ...
        'zAtt': {
            '狮啸功': {
                ...
                'LZ_inf': '连招命中后，本次内伤伤害-70%',
                'remark': '门派成名绝技，不能被闪避及格挡',
                'LZ_Data': {'changeTX': {'hurt_i': [-0.7, 0.1]}},
                'TX_Data': {'lock_zq': 3},
                'count_tt': 0,
                'count_all': 0
            },
        ...
        'person': '1万',
        'star': ['闪反　★★', '闪避　★', '破绽　★', '削耐　★'],
        'inf': '　　慕容氏世代以复国为志，搜罗天下武功秘本，使得“以彼之道、还施彼身”之术更是名震天下。',
