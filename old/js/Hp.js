...
var Hp = {
    createNew: function () {
        ...
        hp.getall = function () {
            hp.all = hp.tou + hp.xiong + hp.fu + hp.yaoL + hp.yaoR + hp.jianL + hp.jianR + hp.shangbiL + hp.shangbiR + hp.qianbiL + hp.qianbiR + hp.zhouL + hp.zhouR + hp.shouwanL + hp.shouwanR + hp.datuiL + hp.datuiR + hp.xiaotuiL + hp.xiaotuiR + hp.xiL + hp.xiR + hp.huaiL + hp.huaiR;
        };
